(function (global, factory) {
        ...
        _createClass(VectorToCursorKeys, [
            ...
            },
            {
                ...
                value: function setVector(x0, y0, x1, y1) {
                    ...
                    this.noKeyDown = true;
                    var dirStates = AngleToDirections(
                        this.angle,
                        this.dirMode,
                        true,
                    );
    ...
    var EventEmitterMethods = {
        setEventEmitter: function setEventEmitter(
            ...
            this._privateEE =
                eventEmitter === true || eventEmitter === undefined;
            this._eventEmitter = this._privateEE
        ...
        listenerCount: function listenerCount() {
            if (this._eventEmitter) {
                return this._eventEmitter.listenerCount.apply(
                    this._eventEmitter,
                    arguments,
                );
            }
        ...
        listeners: function listeners() {
            if (this._eventEmitter) {
                return this._eventEmitter.listeners.apply(
                    this._eventEmitter,
                    arguments,
                );
            }
        ...
        eventNames: function eventNames() {
            if (this._eventEmitter) {
                return this._eventEmitter.eventNames.apply(
                    this._eventEmitter,
                    arguments,
                );
            }
    ...
    var TouchCursor = /*#__PURE__*/ (function (_VectorToCursorKeys) {
        ...
        function TouchCursor(gameObject, config) {
            ...
            var EventEmitterClass = GetValue$1(
                config,
                'EventEmitterClass',
                undefined,
            );
        ...
        _createClass(TouchCursor, [
            {
                ...
                value: function resetFromJSON(o) {
                    _get(
                        _getPrototypeOf(TouchCursor.prototype),
                        'resetFromJSON',
                        this,
                    ).call(this, o);
    ...
    var VirtualJoyStick = /*#__PURE__*/ (function () {
        function VirtualJoyStick(scene, config) {
            ...
            var EventEmitterClass = GetValue(
                config,
                'EventEmitterClass',
                undefined,
            );
    ...
    var VirtualJoyStickPlugin = /*#__PURE__*/ (function (
        _Phaser$Plugins$BaseP,
    ) {
